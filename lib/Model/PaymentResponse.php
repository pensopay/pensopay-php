    ...
    */
    ...
    public function setOrderId($order_id)
    {
        ...
        if ((mb_strlen($order_id) > 30)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling PaymentResponse., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($order_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling PaymentResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-]*$/", ObjectSerializer::toString($order_id)))) {
            throw new \InvalidArgumentException("invalid value for \$order_id when calling PaymentResponse., must conform to the pattern /^[a-zA-Z0-9_\\-]*$/.");
        }
    ...
    public function setTextOnStatement($text_on_statement)
    {
        ...
        if ((mb_strlen($text_on_statement) > 22)) {
            throw new \InvalidArgumentException('invalid length for $text_on_statement when calling PaymentResponse., must be smaller than or equal to 22.');
        }
        if ((mb_strlen($text_on_statement) < 2)) {
            throw new \InvalidArgumentException('invalid length for $text_on_statement when calling PaymentResponse., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[\\x20-\\x7E]*$/", ObjectSerializer::toString($text_on_statement)))) {
            throw new \InvalidArgumentException("invalid value for \$text_on_statement when calling PaymentResponse., must conform to the pattern /^[\\x20-\\x7E]*$/.");
        }
