    ...
    */
    ...
    public function setOrderId($orderId)
    {
        ...
        if ((mb_strlen($orderId) > 30)) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling PaymentResponse., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($orderId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $orderId when calling PaymentResponse., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z0-9_\\-]*$/", ObjectSerializer::toString($orderId)))) {
            throw new \InvalidArgumentException("invalid value for \$orderId when calling PaymentResponse., must conform to the pattern /^[a-zA-Z0-9_\\-]*$/.");
        }
    ...
    public function setTextOnStatement($textOnStatement)
    {
        ...
        if ((mb_strlen($textOnStatement) > 22)) {
            throw new \InvalidArgumentException('invalid length for $textOnStatement when calling PaymentResponse., must be smaller than or equal to 22.');
        }
        if ((mb_strlen($textOnStatement) < 2)) {
            throw new \InvalidArgumentException('invalid length for $textOnStatement when calling PaymentResponse., must be bigger than or equal to 2.');
        }
        if ((!preg_match("/^[\\x20-\\x7E]*$/", ObjectSerializer::toString($textOnStatement)))) {
            throw new \InvalidArgumentException("invalid value for \$textOnStatement when calling PaymentResponse., must conform to the pattern /^[\\x20-\\x7E]*$/.");
        }
