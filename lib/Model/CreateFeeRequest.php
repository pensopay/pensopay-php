    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling CreateFeeRequest., must be smaller than or equal to 2.');
        }
    ...
    public function setFormula($formula)
    {
        ...
        if ((mb_strlen($formula) > 255)) {
            throw new \InvalidArgumentException('invalid length for $formula when calling CreateFeeRequest., must be smaller than or equal to 255.');
        }
