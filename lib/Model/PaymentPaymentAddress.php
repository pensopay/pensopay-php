...
class PaymentPaymentAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['mobileNumber']) && (mb_strlen($this->container['mobileNumber']) > 20)) {
            $invalidProperties[] = "invalid value for 'mobileNumber', the character length must be smaller than or equal to 20.";
        }
    ...
    public function setMobileNumber($mobileNumber)
    {
        ...
        if ((mb_strlen($mobileNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $mobileNumber when calling PaymentPaymentAddress., must be smaller than or equal to 20.');
        }
    ...
    public function setPhoneNumber($phoneNumber)
    {
        ...
        if ((mb_strlen($phoneNumber) > 20)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling PaymentPaymentAddress., must be smaller than or equal to 20.');
        }
