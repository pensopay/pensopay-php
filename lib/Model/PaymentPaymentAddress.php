...
/**
 * PaymentPaymentAddress Class Doc Comment
 *
 * @category Class
 * @package  Pensopay\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaymentPaymentAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'payment.PaymentAddress';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['mobile_number']) && (mb_strlen($this->container['mobile_number']) > 20)) {
            $invalidProperties[] = "invalid value for 'mobile_number', the character length must be smaller than or equal to 20.";
        }
    ...
    public function setMobileNumber($mobile_number)
    {
        ...
        if ((mb_strlen($mobile_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $mobile_number when calling PaymentPaymentAddress., must be smaller than or equal to 20.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling PaymentPaymentAddress., must be smaller than or equal to 20.');
        }
