...
/**
 * ConditionBase Class Doc Comment
 *
 * @category Class
 * @description A rule
 * @package  Pensopay\Client
 ...
 */
class ConditionBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConditionBase';
    ...
    public const METRIC_ACQUIRER = 'acquirer';
    public const METRIC_AMOUNT = 'amount';
    public const METRIC_CARD_COUNTRY = 'card_country';
    public const METRIC_FACILITATOR = 'facilitator';
    public const METRIC_FRAUD_SCORE = 'fraud_score';
    public const METRIC_IP_COUNTRY = 'ip_country';
    public const METRIC_TRANSACTION_TYPE = 'transaction_type';
    public const METRIC_TOKENIZED = 'tokenized';
    ...
    {
        return [
            self::METRIC_ACQUIRER,
            self::METRIC_AMOUNT,
            self::METRIC_CARD_COUNTRY,
            self::METRIC_FACILITATOR,
            self::METRIC_FRAUD_SCORE,
            self::METRIC_IP_COUNTRY,
            self::METRIC_TRANSACTION_TYPE,
            self::METRIC_TOKENIZED,
        ];
    }
