    ...
    */
    ...
    public function setCallbackUrl($callback_url)
    {
        ...
        if ((!preg_match("/^https:\/\//", ObjectSerializer::toString($callback_url)))) {
            throw new \InvalidArgumentException("invalid value for \$callback_url when calling SubscriptionBase., must conform to the pattern /^https:\/\//.");
        }
    ...
    public function setSuccessUrl($success_url)
    {
        ...
        if ((!preg_match("/^https:\/\//", ObjectSerializer::toString($success_url)))) {
            throw new \InvalidArgumentException("invalid value for \$success_url when calling SubscriptionBase., must conform to the pattern /^https:\/\//.");
        }
    ...
    public function setCancelUrl($cancel_url)
    {
        ...
        if ((!preg_match("/^https:\/\//", ObjectSerializer::toString($cancel_url)))) {
            throw new \InvalidArgumentException("invalid value for \$cancel_url when calling SubscriptionBase., must conform to the pattern /^https:\/\//.");
        }
