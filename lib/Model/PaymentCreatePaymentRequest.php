...
class PaymentCreatePaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets methods
     *
     * @param string[]|null $methods The methods allowed for the payment   - card   - mobilepay   - applepay   - anyday   - viabill   - swish   - klarna
     *
     * @return self
     */
    ...
    public function setOrderId($order_id)
    {
        ...
        if ((mb_strlen($order_id) > 30)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling PaymentCreatePaymentRequest., must be smaller than or equal to 30.');
        }
