...
/**
 * UpdateFeeRequest Class Doc Comment
 *
 * @category Class
 * @package  PensoPay\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateFeeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateFeeRequest';
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling UpdateFeeRequest., must be smaller than or equal to 2.');
        }
    ...
    public function setFormula($formula)
    {
        ...
        if ((mb_strlen($formula) > 255)) {
            throw new \InvalidArgumentException('invalid length for $formula when calling UpdateFeeRequest., must be smaller than or equal to 255.');
        }
