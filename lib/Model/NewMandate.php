    ...
    */
    ...
    public function setSuccessUrl($successUrl)
    {
        ...
        if ((!preg_match("/^https:\/\//", ObjectSerializer::toString($successUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$successUrl when calling NewMandate., must conform to the pattern /^https:\/\//.");
        }
    ...
    public function setCancelUrl($cancelUrl)
    {
        ...
        if ((!preg_match("/^https:\/\//", ObjectSerializer::toString($cancelUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$cancelUrl when calling NewMandate., must conform to the pattern /^https:\/\//.");
        }
