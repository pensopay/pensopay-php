    ...
    */
    ...
    public function setCallbackUrl($callbackUrl)
    {
        ...
        if ((!preg_match("/^https:\/\//", ObjectSerializer::toString($callbackUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$callbackUrl when calling SubscriptionResponse., must conform to the pattern /^https:\/\//.");
        }
    ...
    public function setSuccessUrl($successUrl)
    {
        ...
        if ((!preg_match("/^https:\/\//", ObjectSerializer::toString($successUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$successUrl when calling SubscriptionResponse., must conform to the pattern /^https:\/\//.");
        }
    ...
    public function setCancelUrl($cancelUrl)
    {
        ...
        if ((!preg_match("/^https:\/\//", ObjectSerializer::toString($cancelUrl)))) {
            throw new \InvalidArgumentException("invalid value for \$cancelUrl when calling SubscriptionResponse., must conform to the pattern /^https:\/\//.");
        }
