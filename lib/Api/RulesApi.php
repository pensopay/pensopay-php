...
class RulesApi
{
     ...
     *
     * @param  \Pensopay\Client\Model\NewRule $newRule newRule (required)
     ...
     */
    public function createRule($newRule, string $contentType = self::contentTypes['createRule'][0])
    {
        list($response) = $this->createRuleWithHttpInfo($newRule, $contentType);
        return $response;
    }
     ...
     *
     * @param  \Pensopay\Client\Model\NewRule $newRule (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createRule'] to see the possible values for this operation
     *
     * @throws \Pensopay\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function createRuleWithHttpInfo($newRule, string $contentType = self::contentTypes['createRule'][0])
    {
        $request = $this->createRuleRequest($newRule, $contentType);
     ...
     */
    public function createRuleAsync($newRule, string $contentType = self::contentTypes['createRule'][0])
    {
        return $this->createRuleAsyncWithHttpInfo($newRule, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRuleAsyncWithHttpInfo($newRule, string $contentType = self::contentTypes['createRule'][0])
    {
     ...
     */
    public function createRuleRequest($newRule, string $contentType = self::contentTypes['createRule'][0])
    {

        // verify the required parameter 'newRule' is set
        if ($newRule === null || (is_array($newRule) && count($newRule) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $newRule when calling createRule'
            );
        }
        ...
        if (isset($newRule)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($newRule));
            } else {
                $httpBody = $newRule;
            }
     ...
     *
     * @param  int $id Id for the payment (required)
     * @param  \Pensopay\Client\Model\RuleBase $ruleBase ruleBase (required)
     ...
     * @return \Pensopay\Client\Model\RuleResponse
     */
    public function updateRule($id, $ruleBase, string $contentType = self::contentTypes['updateRule'][0])
    {
        list($response) = $this->updateRuleWithHttpInfo($id, $ruleBase, $contentType);
        return $response;
    }
     ...
     *
     * @param  int $id Id for the payment (required)
     * @param  \Pensopay\Client\Model\RuleBase $ruleBase (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateRule'] to see the possible values for this operation
     *
     * @throws \Pensopay\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Pensopay\Client\Model\RuleResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateRuleWithHttpInfo($id, $ruleBase, string $contentType = self::contentTypes['updateRule'][0])
    {
        $request = $this->updateRuleRequest($id, $ruleBase, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateRuleAsync($id, $ruleBase, string $contentType = self::contentTypes['updateRule'][0])
    {
        return $this->updateRuleAsyncWithHttpInfo($id, $ruleBase, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateRuleAsyncWithHttpInfo($id, $ruleBase, string $contentType = self::contentTypes['updateRule'][0])
    {
        $returnType = '\Pensopay\Client\Model\RuleResponse';
        $request = $this->updateRuleRequest($id, $ruleBase, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRuleRequest($id, $ruleBase, string $contentType = self::contentTypes['updateRule'][0])
    {
        ...
        // verify the required parameter 'ruleBase' is set
        if ($ruleBase === null || (is_array($ruleBase) && count($ruleBase) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ruleBase when calling updateRule'
            );
        }
        ...
        if (isset($ruleBase)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ruleBase));
            } else {
                $httpBody = $ruleBase;
            }
        } elseif (count($formParams) > 0) {
