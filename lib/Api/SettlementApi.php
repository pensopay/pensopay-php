...
class SettlementApi
{
     ...
     * Get settlements
     *
     * @param  int|null $per_page How many results to list per page between 1 and 100. (optional, default to 10)
     ...
     * @param  string|null $date_from Find settlements with payout date after or during date_from. Takes an ISO-8601 date string. (optional)
     * @param  string|null $date_to Find settlements with payout date before or during date_to. Takes an ISO-8601 date string. (optional)
