...
class HealthcheckApi
{
     ...
     * Healthcheck
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pingPost'] to see the possible values for this operation
     *
     * @throws \Pensopay\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string
     */
    public function pingPost(string $contentType = self::contentTypes['pingPost'][0])
    {
        list($response) = $this->pingPostWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation pingPostWithHttpInfo
     *
     * Healthcheck
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pingPost'] to see the possible values for this operation
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function pingPostWithHttpInfo(string $contentType = self::contentTypes['pingPost'][0])
    {
        $request = $this->pingPostRequest($contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pingPostAsync(string $contentType = self::contentTypes['pingPost'][0])
    {
        return $this->pingPostAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation pingPostAsyncWithHttpInfo
     *
     * Healthcheck
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pingPost'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pingPostAsyncWithHttpInfo(string $contentType = self::contentTypes['pingPost'][0])
    {
        $returnType = 'string';
        $request = $this->pingPostRequest($contentType);
    ...
    /**
     * Create request for operation 'pingPost'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pingPost'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function pingPostRequest(string $contentType = self::contentTypes['pingPost'][0])
    {
